...
public class TransitionCallbackRecord extends TableRecordImpl<TransitionCallbackRecord> implements Record7<String, String, String, String, String, Timestamp, Byte> {

    private static final long serialVersionUID = 762127528;
     ...
     */
    @Override
    public TransitionCallbackRecord values(String value1, String value2, String value3, String value4, String value5, Timestamp value6, Byte value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TransitionCallbackRecord(String globalid, String fileid, String status, String info, String callbackurl, Timestamp createtime, Byte aggregationstatus) {
        super(TransitionCallback.TRANSITION_CALLBACK);
