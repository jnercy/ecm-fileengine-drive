...
import com.nextcont.drive.jooq.db.information_schema.tables.records.GlobalVariablesRecord;
...
public class GlobalVariables extends TableImpl<GlobalVariablesRecord> {
    ...
    private static final long serialVersionUID = -588603854;
     ...
     */
    public final TableField<GlobalVariablesRecord, String> VARIABLE_NAME = createField("VARIABLE_NAME", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
