...
import com.nextcont.drive.jooq.db.information_schema.tables.records.ColumnPrivilegesRecord;
...
public class ColumnPrivileges extends TableImpl<ColumnPrivilegesRecord> {
    ...
    private static final long serialVersionUID = -1291105566;
     ...
     */
    public final TableField<ColumnPrivilegesRecord, String> TABLE_CATALOG = createField("TABLE_CATALOG", org.jooq.impl.SQLDataType.VARCHAR.length(512), this, "");
