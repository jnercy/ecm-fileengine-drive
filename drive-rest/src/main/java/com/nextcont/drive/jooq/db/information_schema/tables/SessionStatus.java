...
import com.nextcont.drive.jooq.db.information_schema.tables.records.SessionStatusRecord;
...
public class SessionStatus extends TableImpl<SessionStatusRecord> {
    ...
    private static final long serialVersionUID = 309845446;
     ...
     */
    public final TableField<SessionStatusRecord, String> VARIABLE_NAME = createField("VARIABLE_NAME", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
