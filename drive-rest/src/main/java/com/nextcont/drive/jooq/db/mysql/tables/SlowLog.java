...
import com.nextcont.drive.jooq.db.mysql.tables.records.SlowLogRecord;
...
public class SlowLog extends TableImpl<SlowLogRecord> {
    ...
    private static final long serialVersionUID = 1432127888;
     ...
     */
    public final TableField<SlowLogRecord, Timestamp> START_TIME = createField("start_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
